...
import { ComponentPropsWithAs, Element, Ref } from '../system/component_type';
...
type TextComponent = <As extends ElementType = 'span'>(props: TextProps<As>) => Element

export const Text: TextComponent = forwardRef(
  <As extends ElementType = 'span'>(
    props: Omit<TextProps<As>, 'ref'>,
    ref: Ref<As>,
  ) => {
    const { as, size = "inherit", weight = "inherit", typeface = "inherit", className, children, ...rests } = props;
